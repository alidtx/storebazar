            ...
            <li class="nav-item d-xl-none px-3 d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-2 d-flex align-items-center">
                    ...
                    <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4"
                        ...
                        <li class="mb-2">
                            <a class="dropdown-item border-radius-md viewNotification" nid='{{ $notification->id }}' url="{{$notification->redirect_url}}" href="#">
                                <div class="d-flex py-1">
                                    <div class="my-auto">
                                        <img src="{{asset('assets/images/notifications.jpg')}}" class="avatar avatar-sm  me-3 ">
                                    </div>
                                    <div class="d-flex flex-column justify-content-center">
                                        ...
                                        <p class="text-xs text-secondary mb-0">
                                            ...
                                            {{ date('j M, Y H:i:s', strtotime($notification->created_at)) }}
                                        </p>
                                    </div>
                                </div>
                            </a>
                        ...
                        @empty
                        <li><div class="py-4 text-center">No new notification</div></li>
                        @endforelse
