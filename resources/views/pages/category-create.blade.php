        ...
        <div class="card mb-4">
            ...
            <div class="container-fluid py-4">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <form role="form" method="POST" action="{{ route('category.create') }}" id="categoryCreate" enctype="multipart/form-data">
                                @csrf
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="js-example-basic-multiple" name="attribute[]" multiple="multiple">
                                                    ...
                                                    <option value="{{$attribute->id}}">{{$attribute->attributeLabel[0]->label ?? 'N/A'}}</option>
                                                    @endforeach
...
<script>
    jQuery(document).ready(function($) {
        ...
        $("#categoryCreate").submit(function(e) {
            e.preventDefault();
            formPost('categoryCreate', 'category-create', '{{ route("category.create") }}', '{{ route("page", ["page" => "category-list"]) }}')
        });
